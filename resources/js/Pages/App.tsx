                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="card-elevated">
                                ...
                                <p className="text-secondary mb-4">
                                    This card has elevated styling with more
                                    shadow.
                                </p>
                            ...
                            <div className="card-subtle">
                                ...
                                <p className="text-secondary mb-4">
                                    This card has subtle styling without
                                    borders.
                                </p>
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="message-user">
                                <p className="text-primary">
                                    <strong>User:</strong> This is a user
                            ...
                            <div className="message-assistant">
                                <p className="text-primary">
                                    <strong>Assistant:</strong> This is an
                                    assistant response with subtle background.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="alert-info">
                                <strong>Info:</strong> Here&apos;s some helpful
                                information for you.
                            </div>
                        </div>
                    </section>
