          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="card-subtle">
                ...
                <p className="text-secondary mb-4">
                  This card has subtle styling without borders.
                </p>
          ...
          <section>
            ...
            <div className="card space-y-3">
              ...
              <p className="text-primary text-lg">
                Large paragraph text - Primary
              </p>
              <p className="text-secondary">
                Regular paragraph text - Secondary
              </p>
              ...
              <p className="text-accent">
                Accent text for highlights and links
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="card">
              <nav className="flex space-x-1">
                ...
                <a href="http://localhost:8000/about" className="nav-item">
                  About
                </a>
                <a href="http://localhost:8000/about" className="nav-item">
                  Services
            ...
            <div className="space-y-4">
              <div className="message">
                <p className="text-primary">
                  <strong>System:</strong> Welcome to the chat interface!
                </p>
              </div>

              <div className="message-user">
                <p className="text-primary">
                  <strong>User:</strong> This is a user message with accent
                  background.
                </p>
              </div>
              ...
              <div className="message-assistant">
                <p className="text-primary">
                  <strong>Assistant:</strong> This is an assistant response with
                  subtle background.
                </p>
              </div>
            </div>
